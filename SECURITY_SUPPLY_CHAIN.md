...
This repo treats dependency, workflow, source, and extension changes as security-sensitive.

## Required defaults

- Use the committed lockfile with `npm ci` in CI.
...
- Require review for `.github/workflows/`, `.github/actions/`, package manifests, lockfiles, `.npmrc`, source files, and extension config.
